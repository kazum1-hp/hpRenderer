...
最新の実行ファイルは **[こちら](https://github.com/kazum1-hp/hpRenderer/releases)** からダウンロードできます。
...
### メイン画面
<p align="left">
  <img src="./docs/main.png" width="90%"/>
</p>

### G-Buffer 可視化
<p align="left">
  <img src="./docs/gbuffer.png" width="90%"/>
</p>

### PBR
<p align="left">
  <img src="./docs/pbr.png" width="90%"/>
</p>

### リロード（モデル / 環境マップ）
<p align="left">
  <img src="./docs/reload.png" width="90%"/>
</p>

### ポストプロセス（HDR）
<p align="left">
  <img src="./docs/exposure.png" width="90%"/>
</p>
...
本レンダラーは、リアルタイムグラフィックスの実験および将来的なエンジン拡張を目的として設計された、モジュール型のマルチパスレンダリングパイプラインを採用しています。

<p align="left">
  <img src="./docs/renderer_pipeline_jp.png" width="90%"/>
</p>
...
### カメラ操作
- **マウス + QWEASD**: カメラ移動
- **Spaceキー**: カメラを初期位置にリセット

### ライティング
- **1キー**: 平行光源（Directional Light）のON/OFF
- **2キー**: 点光源（Point Light）のON/OFF
...
本プロジェクトで使用している一部のアセットは、[Poly Haven](https://polyhaven.com/) から取得したものです。

また、本プロジェクトの開発にあたり、[LearnOpenGL](https://learnopengl.com/) などの公開資料を参考にしつつ、独自のレンダリングパイプラインとして再設計・実装を行いました。
