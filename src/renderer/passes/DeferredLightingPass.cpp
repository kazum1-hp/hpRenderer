...
namespace Rendering
{
DeferredLightingPass::DeferredLightingPass(AssetManager &resources)
    : lightPassShader(RequireShader(resources, ShaderId::DeferredLighting))
{
...
void DeferredLightingPass::execute(const GpuRenderScene &scene, const RenderPassContext &context, ShadowMapView shadows,
